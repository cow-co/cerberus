...
public class BeaconDTO {
    ...
    public boolean isValid() {
        ...
        boolean isIpValid = (ip != null); // We're ok with the IP being empty, since maybe we don't have that
                                          // information
        boolean isOsValid = (os != null); // As above
        boolean isIntervalValid = (beaconIntervalSeconds > 30); // XXX Hardcoded to 30s for now - config it later (see
                                                                // TODO item above)
